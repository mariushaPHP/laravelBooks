...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _renderBooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renderBooks */ "./src/renderBooks.js");


var accordion = function accordion(books) {
  ...
  (0,_renderBooks__WEBPACK_IMPORTED_MODULE_0__["default"])(books);
};
...
var books = {
  "Grozine": [{
    ...
    'ISBN': 'GR004',
    'year': 1984,
    'name': 'Snieguole ir septyni samurajai',
    'pages': 250,
    'price': 50
  }, {
    'ISBN': 'GR005',
...
var renderBooks = function renderBooks(books) {
  for (var types in books) {
    ...
    var accordHeader = document.createElement('h2');
    accordHeader.className = "accordion-header";
    accordHeader.id = "heading".concat(types);
    var button = document.createElement('button');
    button.className = "accordion-button collapsed";
    button.textContent = "".concat(types, " literat\u016Bra");
    button.setAttribute("data-bs-toggle", "collapse");
    button.setAttribute("data-bs-target", "#collapse".concat(types));
    var accordCollapse = document.createElement('div');
    accordCollapse.className = "accordion-collapse collapse";
    accordCollapse.id = "collapse".concat(types);
    ...
    var _iterator = _createForOfIteratorHelper(books[types]),
        _step;
